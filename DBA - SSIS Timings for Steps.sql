...
--AND		es.execution_path LIKE '%\Warehouse MasterPackage Satsuma\Root\SEQC - warehouse3%'
AND		es.execution_path LIKE '%\Warehouse MasterPackage Satsuma\Root\SEQC - Warehouse3%'
...
AND		e.project_name	= @SSIS
--AND		es.execution_path LIKE '%\Warehouse MasterPackage Satsuma\Root\SEQC - warehouse3%'
AND		es.execution_path LIKE '%\Interface MasterPackage Satsuma\Root\SEQC - Interface2%'
